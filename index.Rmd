...
Despite the common treat it represented (and still represents) for the entire world, individual countries tackled the pandemic with different approaches and policies. Such heterogeneity in government decisions led to variability on the pandemic's effect in specific countries.
...
* Which economy suffered t he most during the pandemic? What’s a good metric to
measure economic and financial impact?

* Which country lagged the most in its recovery? How strong is the relationship between
public health and economic conditions in each country?

* On a holistic approach, which government designed the most effective public policies to deal with the pandemic and the following economic fallout?