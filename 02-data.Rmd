...
* **Health data**: Consisting of positive cases, deaths, vaccination and policy implementation.
...
For a more detailed explanation  of the variables just explained, the [documentation page](https://covid19datahub.io/articles/docs.html) of the data hub is an excellent resource for people interested in using this data set.
